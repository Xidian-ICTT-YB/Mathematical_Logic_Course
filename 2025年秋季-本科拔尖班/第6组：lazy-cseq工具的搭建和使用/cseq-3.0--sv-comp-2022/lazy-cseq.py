...
svcompparamsd.append('--show-backend-output --threads 100 -l lazy --sv-comp --backend cbmc --32 --atomic-parameters --deep-propagation --nondet-condvar-wakeups --data-race-check --contexts 10 --unwind 10')
svcompparamsd.append('--show-backend-output --threads 100 -l lazy --sv-comp --backend cbmc --32 --atomic-parameters --deep-propagation --nondet-condvar-wakeups --data-race-check --contexts 50 --unwind-while=20 --unwind-for=20 --softunwindbound --unwind-for-max=100')
